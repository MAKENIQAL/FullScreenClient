package com.app.fullscreen.mScreen;
...
import com.app.fullscreen.client.FullScreenClient;
...
public class FullScreenSettings {
    ...
    public FullScreenSettings(FullScreenClient fullScreenClient) {
        this.context = fullScreenClient.activity;
